...
**Primary Dependencies**: Spring Boot 3.5, Spring Security 6, Spring Data JPA, jjwt 0.12.6, Lombok, QueryDSL 5.0, Caffeine Cache
**Storage**: MySQL 8+ (운영), H2 인메모리 (테스트). RefreshToken은 CaffeineCache(인메모리)로 관리.
