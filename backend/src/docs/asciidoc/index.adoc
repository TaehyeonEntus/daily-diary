...
include::{snippets}/comments/update/response-fields.adoc[]
...
include::{snippets}/comments/like/http-request.adoc[]
include::{snippets}/comments/like/path-parameters.adoc[]
include::{snippets}/comments/like/http-response.adoc[]

=== 댓글 좋아요 취소

include::{snippets}/comments/unlike/http-request.adoc[]
include::{snippets}/comments/unlike/path-parameters.adoc[]
include::{snippets}/comments/unlike/http-response.adoc[]
