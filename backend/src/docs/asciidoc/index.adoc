...
include::{snippets}/users/update-password/http-request.adoc[]
include::{snippets}/users/update-password/request-fields.adoc[]
include::{snippets}/users/update-password/http-response.adoc[]
